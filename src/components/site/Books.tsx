        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {books.map((b, i) => (
            ...
            >
              ...
              <h3 className="font-bold text-lg leading-snug">{pick(b.title, b.title_ar) || "Book Title"}</h3>
              <p className="mt-1 text-sm text-foreground/60">
                {lang === "ar" ? "تأليف" : "by"} {pick(b.writer, b.writer_ar) || "Author"}
              </p>
              <div className="mt-5 flex items-center justify-between">
                <div>
                  <div className="text-2xl font-black">{b.price || "0"}</div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {[1, 2, 3].map((i) => (
          <div key={i} className="bg-card rounded-3xl p-6 animate-pulse">
            <div className="aspect-[3/4] bg-gray-200 dark:bg-gray-700 rounded-2xl mb-5" />
