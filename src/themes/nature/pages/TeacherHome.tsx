        ...
        <div className="text-center lg:text-right order-2 lg:order-1">
          ...
          <div className="mt-8 flex flex-col items-center lg:items-start gap-3 animate-fade-up delay-300">
            ...
            <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
              <a href="#centers" className="inline-flex items-center gap-2 px-5 py-3 rounded-2xl bg-card border shadow-card font-bold text-sm hover-lift">
                <MapPin className="size-4 text-primary" /> {lang === "ar" ? "مواعيد السناتر" : "Center Hours"}
              </a>
