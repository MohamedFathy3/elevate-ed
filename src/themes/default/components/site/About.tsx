        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <div>
            ...
            >
              ...
              <Link
                to={`/register`}
                className="group flex items-center gap-3 rounded-2xl border border-emerald-200/50 dark:border-emerald-800/50 bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl px-8 py-4 font-semibold transition-all hover:bg-emerald-50/80 dark:hover:bg-emerald-950/30 text-slate-800 dark:text-slate-100"
              >
