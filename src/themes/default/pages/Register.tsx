                      ...
                      <div className="flex p-1 rounded-xl bg-slate-100 dark:bg-slate-800/80">
                        {(["general", "azhar"] as const).map((type) => (
                          <button
                            ...
                            className={`flex-1 px-4 py-2.5 rounded-lg text-sm font-medium transition-all ${formData.type_of_study === type ? toggleActive : toggleInactive
                              }`}
                          >
                      ...
                      <div className="flex p-1 rounded-xl bg-slate-100 dark:bg-slate-800/80">
                        {(["online", "center"] as const).map((type) => (
                          <button
                            ...
                            className={`flex-1 px-4 py-2.5 rounded-lg text-sm font-medium transition-all ${formData.type_of_attendance === type ? toggleActive : toggleInactive
                              }`}
                          >
                      ...
                      <div className="flex p-1 rounded-xl bg-slate-100 dark:bg-slate-800/80">
                        {(["male", "female"] as const).map((gender) => (
                          <button
                            ...
                            className={`flex-1 px-4 py-2.5 rounded-lg text-sm font-medium transition-all ${formData.gender === gender ? toggleActive : toggleInactive
                              }`}
                          >
