...
const translations = {
  ...
  "features.eyebrow": "WHY CHOOSE US",
    ...
    "features.subtitle": "Powerful tools that make learning effective and enjoyable",
    "f1.title": "Interactive Learning",
    "f1.body": "Engaging content that keeps students motivated",
    "f2.title": "Live Support",
    "f2.body": "24/7 assistance from expert teachers",
    "f3.title": "Self-Paced",
    "f3.body": "Learn at your own speed, anytime anywhere",
    "f4.title": "Certificates",
    "f4.body": "Earn recognized certificates upon completion",
    "f5.title": "Community",
    "f5.body": "Connect with fellow learners worldwide",
    "f6.title": "Lifetime Access",
    "f6.body": "Access course materials forever",
  ...
  ar: {
    ...
    "features.subtitle": "أدوات قوية تجعل التعلم فعالاً وممتعاً",
    "f1.title": "تعلم تفاعلي",
    "f1.body": "محتوى جذاب يحفز الطلاب على الاستمرار",
    "f2.title": "دعم مباشر",
    "f2.body": "مساعدة على مدار الساعة من معلمين خبراء",
    "f3.title": "بوتيرة ذاتية",
    "f3.body": "تعلم بسرعتك الخاصة، في أي وقت وأي مكان",
    "f4.title": "شهادات معتمدة",
    "f4.body": "احصل على شهادات معترف بها عند الإكمال",
    "f5.title": "مجتمع تعليمي",
    "f5.body": "تواصل مع زملائك المتعلمين حول العالم",
    "f6.title": "وصول مدى الحياة",
    "f6.body": "الوصول إلى مواد الدورة مدى الحياة",
